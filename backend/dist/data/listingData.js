...
exports.propertyListing = exports.listingReviews = exports.listingAmenities = exports.photoCategories = exports.listingPhotos = void 0;
exports.listingPhotos = [
    {
        id: 'photo-1',
    ...
    {
        id: 'photo-7',
        url: 'https://images.unsplash.com/photo-1540518614846-7ede433c4ef9?auto=format&fit=crop&w=1200&q=85',
...
exports.photoCategories = [
    { id: 'all', name: 'All photos', photoCount: 15, coverUrl: exports.listingPhotos[0].url },
    { id: 'living', name: 'Living room', photoCount: 3, coverUrl: exports.listingPhotos[0].url },
    { id: 'bedroom', name: 'Bedroom', photoCount: 3, coverUrl: exports.listingPhotos[1].url },
    { id: 'jacuzzi', name: 'Jacuzzi & Spa', photoCount: 2, coverUrl: exports.listingPhotos[2].url },
    { id: 'kitchen', name: 'Kitchenette & Dining', photoCount: 2, coverUrl: exports.listingPhotos[9].url },
    { id: 'bathroom', name: 'Bathroom', photoCount: 2, coverUrl: exports.listingPhotos[11].url },
    { id: 'outdoor', name: 'Outdoor & Pool', photoCount: 3, coverUrl: exports.listingPhotos[4].url }
];
exports.listingAmenities = [
...
exports.propertyListing = {
    ...
    amenities: exports.listingAmenities,
    rules: {
    ...
    photos: exports.listingPhotos,
    categories: exports.photoCategories
};
